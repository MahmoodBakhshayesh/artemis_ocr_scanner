...
@available(iOS 10.0, *)
class OcrScannerView: NSObject, FlutterPlatformView, AVCapturePhotoCaptureDelegate, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    init(
        ...
        _view = UIView()
        self.channel = FlutterMethodChannel(name:"artemis_ocr_scanner",binaryMessenger: messenger!)
        self.frame = frame
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case "initCamera":
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.2) {
                ...
                self.initCamera( flashMode: initFlashModeID, fill: fill, cameraID: cameraTypeID,modeID: modeID)
    ...
    func initCamera( flashMode: Int, fill: Bool,  cameraID: Int, modeID: Int) {
