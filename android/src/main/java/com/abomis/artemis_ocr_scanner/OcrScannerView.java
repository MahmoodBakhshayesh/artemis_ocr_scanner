...
import com.abomis.artemis_ocr_scanner.Model.CornerPointModel;
import com.abomis.artemis_ocr_scanner.Model.LineModel;
...
class OcrScannerView implements PlatformView, OcrScannerViewInterface, MethodChannel.MethodCallHandler, FlutterMethodListener {
    ...
    public OcrScannerView(ActivityPluginBinding activityPluginBinding, BinaryMessenger binaryMessenger, int viewId) {
        this.activityPluginBinding = activityPluginBinding;
        this.channel = new MethodChannel(binaryMessenger, "artemis_ocr_scanner");
...
//                int barcodeTypeID = call.argument("barcodeTypeID");
                ...
                initCamera( initFlashModeID, fill, cameraID, modeID);
                break;
    ...
    @Override
    public void initCamera( int flashModeID, boolean fill, int cameraID, int modeID) {
